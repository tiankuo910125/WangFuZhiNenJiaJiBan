 ...
 */
public class JournalActivity extends Activity implements OnClickListener, XListView.IXListViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mam.pushOneActivity(JournalActivity.this);
        page = 0;
        scrollTag = true;
        refreshTag = false;
...
//        journal_layout.addView(journal_list);
    ...
    private void getData(int pageTag) {
        ...
        logListGinseng.setDevice_id(deviceid);
        logListGinseng.setPage(pageTag);
        logListGinseng.setProduct_key(product_key);

        HttpInterface httpInterface = retrofit.create(HttpInterface.class);

        Call<ResultBean> call = httpInterface.getLogList("smart/v1/Event/DeivceEventLog?accessToken=" + PreferenceUtil.getString("accessToken"), logListGinseng);
        call.enqueue(new Callback<ResultBean>() {
            ...
            public void onResponse(Call<ResultBean> call, Response<ResultBean> response) {
                ...
                if (resultBean != null && resultBean.getCode() == 200) {
                    ...
                    AppUtils.show(JournalActivity.this, resultBean.getMessage());
                }
                onLoad();
                refreshTag = false;
            ...
            public void onFailure(Call<ResultBean> call, Throwable t) {
                AppUtils.show(JournalActivity.this, "加载数据失败");
                onLoad();
                refreshTag = false;
                if (kProgressHUD != null && kProgressHUD.isShowing()) {
                    kProgressHUD.dismiss();
    ...
    protected void onDestroy() {
        super.onDestroy();
        mam.popOneActivity(JournalActivity.this
        );
    }
